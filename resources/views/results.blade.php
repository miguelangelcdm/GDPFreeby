...
<body class="dark-mode antialiased">
    <div
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-left z-10">
            <a href="{{ url('/') }}"
                class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><svg
        ...
        <div class="mx-auto p-6 lg:p-8 flex-row flex gap-x-10">
            <div class="flex flex-col justify-center" style="width: 30vw">
                ...
                <div style="width:100%">
                    <form action="{{ url('/process-csv2') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="threshold"
                                value="{{ isset($threshold) ? $threshold / 100 : null }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required>
                        </div>
                        <button type="submit"
                ...
                @endif
                <div>
                    <form method="POST" action="{{ url('/utilstorage') }}">
                        @csrf
                        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Te sirvio?</button>
                    </form>                    
                </div>
            </div>
            @if (isset($matrix) && !empty($matrix))
