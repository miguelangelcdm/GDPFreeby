    ...
    <div class="topbar">
      ...
      <div>
        <form method="POST" action="{{ url('/utilstorage') }}">
          @csrf
          <button type="submit"
            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Te
            sirvio?</button>
        </form>
      </div>
    </div>
    <div class="mx-auto p-6 lg:p-8 flex-col flex gap-x-10 lg:flex-row pt-24" style="width: -webkit-fill-available">
          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 sticky top-0">
              <tr>
                ...
                {{-- <th scope="col" class="px-6 py-3">Game Instance</th> --}}
